          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {listing.floor && (
              <div>
                ...
                <p className="font-semibold">{listing.floor}/{(listing as any).floors || '?'}</p>
              </div>
            )}
        ...
        {listing.partnerData && (
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 mb-4">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">{(listing.partnerData as any).partnerName}</span>
            </div>
          </div>
        )}
...
export default dynamic(() => Promise.resolve(ListingDetailPageInner), { ssr: false });